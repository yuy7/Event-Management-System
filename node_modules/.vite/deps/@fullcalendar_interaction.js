import {
  ...
  whenTransitionDone
<<<<<<< HEAD
} from "./chunk-THU3PMAS.js";
=======
} from "./chunk-ICS7BIPA.js";
>>>>>>> 158bc43ba660bb4786fc37106b4be81ab62a6eae
    ...
    for (let id in droppableStore) {
      ...
      if (offsetTracker && offsetTracker.isWithinClipping(offsetLeft, offsetTop)) {
        ...
        if (positionLeft >= 0 && positionLeft < width && positionTop >= 0 && positionTop < height) {
          ...
          if (hit && rangeContainsRange(hit.dateProfile.activeRange, hit.dateSpan.range) && (this.disablePointCheck || offsetTracker.el.contains(document.elementFromPoint(
...
var fullcalendar_interaction_default = index;
export {
