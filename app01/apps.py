...
#class
from Model.ClassAbout import get_class_list, get_class_students, add_student_to_class, remove_student_from_class,add_class
...
app.route("/addClass",methods=["POST"])(add_class)
