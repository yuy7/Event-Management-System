...
def EventCreate():
    ...
    # 创建新活动并保存到数据库
    newEvent = Event(eventName=eventName, eventStartDate=eventStartDate, eventEndDate=eventEndDate, eventLocation=eventLocation, requireApproval=requireApproval, creator_id=user_id)
