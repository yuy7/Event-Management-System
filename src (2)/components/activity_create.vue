  ...
  <div class="container">
    ...
    <div class="activity-create">
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          <label for="activity-date">活动时间:</label>
          <input type="datetime-local" id="activity-date" v-model="activity.date" required>
        </div>
...
export default {
  ...
  methods: {
    submitForm() {
      axios.post('http://localhost:5000/submit', this.activity)
        .then(response => {
